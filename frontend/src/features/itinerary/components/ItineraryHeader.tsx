...
export const ItineraryHeader: React.FC<ItineraryHeaderProps> = ({ itinerary, showActions = true, compact = false }) => {
    ...
    <div className={`relative bg-gray-900 rounded-[2rem] overflow-hidden shadow-2xl shadow-primary/10 ${compact ? 'p-6 mb-5' : 'p-8 md:p-12 mb-12'}`}>
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="max-w-2xl">
          ...
          <h1 className={`font-black text-white mb-4 tracking-tight leading-[1.1] ${compact ? 'text-3xl' : 'text-5xl md:text-6xl mb-6'}`}>
