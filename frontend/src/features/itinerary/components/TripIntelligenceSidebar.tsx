...
export const TripIntelligenceSidebar: React.FC<TripIntelligenceSidebarProps> = ({ itinerary }) => {
  return (
    <div className="bg-white dark:bg-[#16142e] rounded-[2rem] shadow-xl shadow-gray-200/50 dark:shadow-black/20 border border-gray-100 dark:border-indigo-500/10 p-8 sticky top-8">
      ...
      <button className="w-full mt-10 flex items-center justify-center gap-3 py-4 rounded-2xl bg-gray-50 dark:bg-slate-800/50 text-gray-900 dark:text-indigo-100 font-bold hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors border border-gray-100 dark:border-slate-700">
