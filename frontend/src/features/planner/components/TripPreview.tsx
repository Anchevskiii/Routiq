  ...
  return (
    <section className="relative bg-white dark:bg-[#1e1b38] border border-line rounded-[22px] shadow-card overflow-visible">
      ...
      <div className="px-[22px] pt-5 pb-1.5">
        ...
        <div className="mt-3.5 border border-line rounded-[14px] p-4 bg-gradient-to-b from-white to-blue-50/40 dark:from-[#1e1b38] dark:to-blue-900/10">
          ...
          <div className="relative h-7 rounded-full overflow-hidden bg-gradient-to-r from-blue-100/80 to-blue-50/80 dark:from-blue-900/40 dark:to-blue-50/40">
            <div
            ...
            >
              <span className="absolute right-[-3px] top-1/2 -translate-y-1/2 w-3.5 h-3.5 bg-white dark:bg-[#1e1b38] rounded-full shadow-[0_0_0_3px_theme(colors.blue.600),0_2px_10px_var(--accent-glow)]" />
            </div>
          </div>
        ...
        {moods.map(m => (
          <span
            ...
            className={[
              ...
              experience
                ? 'text-blue-600 border-blue-600 bg-blue-50/60 dark:bg-blue-900/20'
